...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-semibold text-center text-gray-800 mb-6">Manage Members</h1>

    <a href="addMember.jsp" class="text-white bg-blue-600 px-4 py-2 rounded-md hover:bg-blue-700">Add New Member</a>
    ...
    <div class="overflow-x-auto mt-6 bg-white p-4 rounded-lg shadow-md">
        <table class="min-w-full table-auto">
            ...
            <tbody>
            <!-- Loop through members and display them here -->
            <tr class="border-b">
                <td class="px-4 py-2">1</td>
                <td class="px-4 py-2">John Doe</td>
                <td class="px-4 py-2">
                    <a href="editMember.jsp?id=1" class="text-blue-600 hover:text-blue-800">Edit</a> |
                    <a href="deleteMember.jsp?id=1" class="text-red-600 hover:text-red-800">Delete</a>
                </td>
            </tr>
