...
<div class="container mx-auto p-8">
    ...
    <form action="addMemberAction.jsp" method="POST" class="bg-white shadow-md rounded-lg p-6">
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <select name="role" id="role" class="mt-2 w-full px-4 py-2 border border-gray-300 rounded-lg" required>
