...
<div class="card-container">
    <div class="card" onclick="openModal('Yoga Session', '12th March, 2025', 'Join us for a relaxing yoga session to unwind.')">
        <h2 class="text-xl font-semibold text-blue-500">Yoga Session</h2>
        <p class="text-sm text-gray-600">12th March, 2025</p>
        <p class="text-gray-800 mt-2">Join us for a relaxing yoga session to unwind.</p>
    </div>
